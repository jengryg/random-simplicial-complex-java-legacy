...
public class VietorisRipsComplexSVG extends VietorisRipsComplex {
    ...
    public VietorisRipsComplexSVG(List<double[]> aVertices, double aDistance) {
        super(aVertices, aDistance);
    }

    public VietorisRipsComplexSVG(List<List<int[]>> aSimplicies, List<double[]> aVertices, double aDistance) {
        super(aSimplicies, aVertices, aDistance);
    }

    public VietorisRipsComplexSVG(String code) {
        super(code);
    }
    ...
    public void svgOneSkeleton() {
        ...
        drawSimplicesOfDimension(svgGraphics2D[0], 1);
        drawSimplicesOfDimension(svgGraphics2D[1], 1);
        drawSimplicesOfDimension(svgGraphics2D[2], 1);
        drawSimplicesOfDimension(svgGraphics2D[3], new Color(0, 0, 255, 128), 1);
        drawSimplicesOfDimension(svgGraphics2D[4], new Color(0, 0, 255, 128), 1);
    ...
    public void drawSimpliciesOfDimensionAndComponent(SVGGraphics2D aSVGGraphics2D, int dimension, int componentId) {
        drawSimpliciesOfDimensionAndComponent(aSVGGraphics2D, TRANSPARENT, dimension, componentId);
    }

    public void drawSimpliciesOfDimensionAndComponent(SVGGraphics2D aSVGGraphics2D, Color aColor, int dimension, int componentId) {
